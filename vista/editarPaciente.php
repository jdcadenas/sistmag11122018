              ...
              <form method="get" action="" id="form_mod">
                ...
                <div class="form-row">
                  <div class=" col-lg-4 col-md-4 col-sm-4">
                    <select class="form-control" id="estadomod" name="estado" data-style="btn btn-success btn-round">
                    ...
                    <select class="form-control" id="municipiomod" name="municipiomod" data-style="btn btn-success btn-round">
                      ...
                      <?php foreach ($datosm as $municipio => $fila) { ?>
                        <?php if ($fila->id_municipio == $muni->municipio_id): ?>
                          <option value="<?php echo $fila->id_municipio ?>" selected="selected">
                            <?php echo $fila->nombre ?>
                          </option>
                        <?php endif ?>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4">
                    ...
                    <select class="form-control" id="parroquiamod" name="parroquiamod" data-style="btn btn-success btn-round">
                      <option disabled >Parroquia</option>
                      <?php foreach ($datosp as $parroquia => $fila) { ?>
                        <?php if ($fila->id_parroquia == $pac->id_parroquia): ?>
                          <option value="<?php echo $fila->id_parroquia ?>" selected="selected">
                            <?php echo $fila->nombre ?>
                          </option>
                        <?php endif ?>
                        <option value="<?php echo $fila->id_parroquia ?>">
                          <?php echo $fila->nombre ?>
                        </option>
                      <?php } ?>
                    </select>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group label-floating has-success col-lg-4 col-md-4 col-sm-4">
                    ...
                    <input type="number" class="form-control" name="peso_paciente" id="peso_paciente"
                           required="required" value="<?php echo $pac->peso_paciente; ?>">
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-lg-4 col-md-4 col-sm-4">
                    <select class="form-control" name="estadocivil_paciente" id="edocivilmod" data-style="btn btn-success btn-round">
                      <option disabled selected>Estado Civil</option>
                      <?php
                      $esci = $pac->estadocivil_paciente;
                      if ($esci == 'Soltero(a)') {
                        ?>
                  ...
                  <div class="form-group col-lg-4 col-md-4 col-sm-4">
                    <select class="form-control" name="nacionalidad_paciente" id="nacionamod"  data-style="btn btn-success btn-round">
                      <option disabled selected>Nacionalidad</option>
                      <?php
                      $nac = $pac->nacionalidad_paciente;
                      if ($nac == 'Venezolano') {
                        ?>
