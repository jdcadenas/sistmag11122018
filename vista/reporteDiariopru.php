  ...
  <div class="col-md-8">
    <div class="card">
      <div class="card-header card-header-success">
        <h4 class="card-title">
          Reportes de Pruebas Realizadas del día <?php echo $fecha ?>
        </h4>
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card-body">
      <div class="table-responsive datatables"><title class="fechapru">Reporte Diario del día <?php echo $fecha ?></title>
