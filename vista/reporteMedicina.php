  ...
  <div class="col-md-8">
    <div class="card">
      <div class="card-header card-header-success">
        <h4 class="card-title">
          Reportes de Medicinas Totales Entregadas 
        </h4>
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card-body">
      <div class="table-responsive datatables"><title class="fechapru">Reportes de Medicinas Totales Entregadas</title>
        <table class="table display" data-toggle="table" id="reporte">
          ...
          <tbody>
            <?php
            foreach ($datosreportemedicina as $paciente =>
              $valor) :   ?>
