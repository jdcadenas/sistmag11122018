  ...
  <div class="col-md-8">
    <div class="card">
      <div class="card-header card-header-success">
        <h4 class="card-title">
          Reporte Semanal de Los Tratamientos Realizados Desde:  <?php echo $fechasinitra. " Hasta: " .$fechasfintra ?>
        </h4>
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card-body">
      <div class="table-responsive datatables"><title class="semanaltra">Reporte Semanal de las Pruebas Realizadas Desde: <?php echo $fechasinitra. " Hasta: " .$fechasfintra ?></title>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  ...
  var semanaltra = $('.semanaltra').text();
