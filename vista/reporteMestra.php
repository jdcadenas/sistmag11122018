  ...
  <div class="col-md-8">
    <div class="card">
      <div class="card-header card-header-success">
        <h4 class="card-title">
          Reporte Mensual de Tratamientos Realizados Desde: <?php echo $mesinitra. " Hasta: " .$mesfintra ?>
        </h4>
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card-body">
      <div class="table-responsive datatables"><title class="mensualtra">Reporte Mensual de Tratamientos Realizados Desde: <?php echo $mesinitra. " Hasta: " .$mesfintra ?></title>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  ...
  var mensualtra = $('.mensualtra').text();
