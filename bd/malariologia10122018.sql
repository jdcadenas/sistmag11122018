...
CREATE TABLE pruebas (
    ...
    codigo_notificacion character varying(50),
...
CREATE TABLE usuario_sistema (
    ...
    usuario_sistema character varying(40),
...
SELECT pg_catalog.setval('caso_id_seq', 63, true);
...
SELECT pg_catalog.setval('paciente_caso_id_seq', 60, true);
...
SELECT pg_catalog.setval('paciente_id_seq', 121, true);
...
SELECT pg_catalog.setval('paciente_pruebas_id_seq', 74, true);
...
SELECT pg_catalog.setval('paciente_tratamiento_id_seq', 53, true);
...
SELECT pg_catalog.setval('pruebas_id_seq', 76, true);
...
SELECT pg_catalog.setval('tratamiento_id_seq', 53, true);
...
21	aleidacamacho	123456	Aleida	Camacho	850145	2	55555555555	ale@g.com	\N
22	aliangy	123456	Aliangy	Rodriguez	21296268	2	41588888888	aliangy@g.com	\N
\.
